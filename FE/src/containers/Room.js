        ...
        <div>
            {
                messageList.map(message => {
                    ...
                    switch (message.type) {
                        ...
                        case 'correct_ans':
                            return (
                                <div className="sys_message" key={message.timestamp}>
                                    <div className="info system">
                            <span className="by">{message.content}</span>
                                    </div>
                                </div>
                            );   
                        case 'bystanderMsg':
                            return (
                                <div className="message" key={message.timestamp}>
                                    <div className="info">
                                        <span className="by">{ getPersonName(message.by) }</span><span className="tp">[ByStander]</span>
                                        <span className="time">{ getFormatTime(message.timestamp, 'HMS') }</span>
                                    </div>
                                    <div className="content">{ message.content }</div>
                                </div>
